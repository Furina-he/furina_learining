...
source: "https://x.com/yupi996/status/2066811881764086240"
author:
  - "[[@yupi996]]"
published: 2026-06-16
created: 2026-06-19
description: "大家好，我是程序员鱼皮。AI 编程圈又又又出新概念了……这次的起因是 Claude Code 之父 Boris Cherny 在最新访谈中说：我不再提示 Claude 了，我有一堆循环在运行，它们才是在提示 Claude 并判断接下来该做什么。我的工作变成了写循环。紧接着，Ope..."
tags:
  - "clippings"
---
![图像](https://pbs.twimg.com/media/HK7F4vyawAAkBrh?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/HK66VEEaMAAWNK_?format=png&name=large)
...
![图像](https://pbs.twimg.com/media/HK66X7VbkAAh0Gw?format=png&name=large)
...
![图像](https://pbs.twimg.com/media/HK66ZLSb0AI_2dz?format=png&name=large)
...
![图像](https://pbs.twimg.com/media/HK66aXcbAAAVOo1?format=png&name=large)
...
![图像](https://pbs.twimg.com/media/HK66bqeaoAAQJT5?format=png&name=large)
...
![图像](https://pbs.twimg.com/media/HK66dDpagAA8cqr?format=png&name=large)
...
![图像](https://pbs.twimg.com/media/HK66eQdaAAA052b?format=png&name=large)
...
![图像](https://pbs.twimg.com/media/HK66fuqaIAAcmu5?format=png&name=large)
...
![图像](https://pbs.twimg.com/media/HK66g63aMAA35Up?format=png&name=large)
...
![图像](https://pbs.twimg.com/media/HK66ii_b0AAtQOG?format=png&name=large)
...
![图像](https://pbs.twimg.com/media/HK66kYtbwAAVWpv?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/HK66mzYbgAAEjl4?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/HK66oBNagAAc5xx?format=png&name=large)
...
![图像](https://pbs.twimg.com/media/HK66pPsaQAAV5Rb?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/HK66rb2bUAAbIzh?format=jpg&name=large)

创建成功后，时间一到 Codex 就会自动开启一个对话来执行任务。你也可以手动执行一次先看看效果。

点击任务，能够查看详细信息：

![图像](https://pbs.twimg.com/media/HK7GC1gaQAAnbF7?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/HK7GJkdbsAAVTvG?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/HK7GP1QagAAGGEn?format=jpg&name=large)

最终 AI 花了将近 50 分钟，独立完成了整个系统的开发和验证，不需要我中间插手。三个服务全部能正常启动，核心功能都能跑通。

打开桌面 APP 看看效果。主界面有一个 AI 对话框，下面预置了常见开发环境的快捷入口：

![图像](https://pbs.twimg.com/media/HK7JrlkbEAAMjWD?format=jpg&name=large)

选择想安装的软件和版本后，AI 会自动生成完整的安装脚本和方案，包含中文注释、环境检测、验证命令，可以直接复制执行或者点击一键安装：

![图像](https://pbs.twimg.com/media/HK7Jx98bcAEbSKw?format=jpg&name=large)
...
![图像](https://pbs.twimg.com/media/HK7Jibxa0AA-B8d?format=png&name=large)
...
![图像](https://pbs.twimg.com/media/HK7JbBUaEAAPF07?format=png&name=large)
...
![图像](https://pbs.twimg.com/media/HK7J2Z0bYAAmXXz?format=png&name=large)
...
![图像](https://pbs.twimg.com/media/HK7J7Vca4AAJaQS?format=png&name=large)
...
如果你想系统学习前面几个阶段的知识，可以看我免费开源的 [《AI 编程零基础入门教程》](https://ai.codefather.cn/vibe)，里面从零基础入门到 Harness 实战都有完整的讲解。

> 开源指路：[https://github.com/liyupi/ai-guide](https://github.com/liyupi/ai-guide)

![图像](https://pbs.twimg.com/media/HK7GUYlaUAAaD42?format=jpg&name=large)
