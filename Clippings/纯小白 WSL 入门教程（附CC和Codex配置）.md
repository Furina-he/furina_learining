---
title: "纯小白 WSL 入门教程（附CC和Codex配置）"
source: "https://linux.do/t/topic/1015067"
author:
  - "[[DabblerLi]]"
published:
created: 2026-05-18
description: "进 L 站也有一段时间了，白嫖了各位佬的各种资源，发现自己竟然一篇帖子也没发过😣，今天就来发一个关于 WSL 的基础教程来回馈一下社区，本人也不是大手子，如有错误还望各位佬指正修改，也欢迎各位佬来补充。 碎碎念 其实快三级了，来凑一下点赞，随便弄个徽章 关于 WSL WSL"
tags:
  - "clippings"
---
...
> 碎碎念
> 
> 其实快三级了，来凑一下点赞，随便弄个徽章![:face_savoring_food:](https://linux.do/images/emoji/twemoji/face_savoring_food.png?v=15 ":face_savoring_food:")

# 关于 WSL

WSL（Windows Subsystem for Linux）（Windows Linux 子系统）  
或许有人会问装 WSL 干嘛，WSL 更轻量，可以用来学习 Linux，做开发，且更方便与 Win 之间切换互通，我第一次了解到它是在 Win 上用 docker 的时候， 还有就是很好玩![:face_savoring_food:](https://linux.do/images/emoji/twemoji/face_savoring_food.png?v=15 ":face_savoring_food:")
...
[![WSL1](https://cdn3.ldstatic.com/original/4X/6/a/d/6adeda59d02b267bbb545febb50d51b29ff49284.png)

WSL1525×329 57.6 KB

](https://cdn3.ldstatic.com/original/4X/6/a/d/6adeda59d02b267bbb545febb50d51b29ff49284.png "WSL1")

开启下面两项

[![WSL2](https://cdn3.ldstatic.com/original/4X/7/b/d/7bdfaf9e22b1b03944d1f71b24a612f045256b98.png)

WSL2371×118 5.28 KB

](https://cdn3.ldstatic.com/original/4X/7/b/d/7bdfaf9e22b1b03944d1f71b24a612f045256b98.png "WSL2")
...
[![WSL3](https://cdn3.ldstatic.com/optimized/4X/b/4/a/b4a01ccf7d18bf654756dc06b858942097b86f38_2_367x375.jpeg)

WSL3815×831 140 KB

](https://cdn3.ldstatic.com/original/4X/b/4/a/b4a01ccf7d18bf654756dc06b858942097b86f38.jpeg "WSL3")

新手推荐使用 Ubuntu，我日常用的是 Ubuntu-24.04，不过我也装了个 archlinux，喜欢折腾的可以试试，按自己的喜好选择即可，下面开始安装

![](https://linux.do/letter_avatar/hengnix/48/5_c16b2ee14fe83ed9a59fc65fbec00f85.png) 平衡:> 补充一下安装 WSL2 的时候可以使用 `--location` 指定安装位置，比如
> 
> ```css
...
[![WSL4](https://cdn3.ldstatic.com/original/4X/1/c/5/1c58316668ed5849206dbc202fdd0c5952cc9190.png)

WSL4256×183 3.34 KB

](https://cdn3.ldstatic.com/original/4X/1/c/5/1c58316668ed5849206dbc202fdd0c5952cc9190.png "WSL4")
...
![](https://linux.do/user_avatar/linux.do/goodchuai/48/826396_2.png) Sir. That Way:> 换源可以用 [https://linuxmirrors.cn/](https://linuxmirrors.cn/)  
...
这样就好了，可以执行下方命令试试（看谁跟我一样喜欢这大长串命令![:face_savoring_food:](https://linux.do/images/emoji/twemoji/face_savoring_food.png?v=15 ":face_savoring_food:")）
...
![WSLg](https://cdn3.ldstatic.com/original/4X/4/9/a/49a372e064ece57c7883d008991114c388546658.png)
...
接下来就可以爽用了![:face_savoring_food:](https://linux.do/images/emoji/twemoji/face_savoring_food.png?v=15 ":face_savoring_food:")
...
接下来同样爽用![:face_savoring_food:](https://linux.do/images/emoji/twemoji/face_savoring_food.png?v=15 ":face_savoring_food:")
...
[![cc-switch1](https://cdn3.ldstatic.com/original/4X/5/9/6/59672cb51e293de77d7f18af14c24c63382e8b98.png)

cc-switch1714×331 14.2 KB

](https://cdn3.ldstatic.com/original/4X/5/9/6/59672cb51e293de77d7f18af14c24c63382e8b98.png "cc-switch1")

找到自己安装 CC 和 Codex 的发行版

[![cc-switch2](https://cdn3.ldstatic.com/optimized/4X/6/6/8/6688b3d2ebab79965ca401ae41c3f8f9b6ab16af_2_690x455.png)

cc-switch21476×974 57.8 KB

](https://cdn3.ldstatic.com/original/4X/6/6/8/6688b3d2ebab79965ca401ae41c3f8f9b6ab16af.png "cc-switch2")

找到配置文件夹位置，分别选择

[![cc-switch3](https://cdn3.ldstatic.com/optimized/4X/1/0/4/104251f738a6e60bcc8d0b5878358034d5de7f4d_2_690x455.png)

cc-switch31476×975 65.8 KB

](https://cdn3.ldstatic.com/original/4X/1/0/4/104251f738a6e60bcc8d0b5878358034d5de7f4d.png "cc-switch3")

最后效果

[![cc-switch4](https://cdn3.ldstatic.com/original/4X/9/2/a/92ac2cea435732cd8c5b1b25e037551d4f60eefb.png)

cc-switch4709×315 9.25 KB

](https://cdn3.ldstatic.com/original/4X/9/2/a/92ac2cea435732cd8c5b1b25e037551d4f60eefb.png "cc-switch4")
...
[![VSC-WSL1](https://cdn3.ldstatic.com/optimized/4X/4/8/a/48a65554eafc4f2702e73baac6364324057d7d66_2_517x99.png)

VSC-WSL11160×225 31.1 KB

](https://cdn3.ldstatic.com/original/4X/4/8/a/48a65554eafc4f2702e73baac6364324057d7d66.png "VSC-WSL1")

  

[![VSC-WSL2](https://cdn3.ldstatic.com/optimized/4X/a/0/0/a00bd36ceb1a16f78236ce8988216078f5d08600_2_517x125.png)

VSC-WSL2904×220 23.8 KB

](https://cdn3.ldstatic.com/original/4X/a/0/0/a00bd36ceb1a16f78236ce8988216078f5d08600.png "VSC-WSL2")

然后就可以在左侧栏的远程资源管理器中连接 WSL 发行版了

[![VSC-WSL3](https://cdn3.ldstatic.com/optimized/4X/7/c/4/7c4f198c214bfb8f89fc082caa078071dc17da1c_2_273x375.png)

VSC-WSL3437×597 17.3 KB

](https://cdn3.ldstatic.com/original/4X/7/c/4/7c4f198c214bfb8f89fc082caa078071dc17da1c.png "VSC-WSL3")
...
[![docker1](https://cdn3.ldstatic.com/optimized/4X/5/f/a/5fa052cc5cad1ac51f95f9f34c11eaffc39b5454_2_645x499.png)

docker1899×696 60.3 KB

](https://cdn3.ldstatic.com/original/4X/5/f/a/5fa052cc5cad1ac51f95f9f34c11eaffc39b5454.png "docker1")

然后在如下位置打开WSL集成，勾选你想要使用docker的发行版，记得应用设置

[![docker2](https://cdn3.ldstatic.com/optimized/4X/6/9/b/69b1eea9127049d38c65290f13844de10bcc4807_2_690x381.png)

docker21217×673 49.3 KB

](https://cdn3.ldstatic.com/original/4X/6/9/b/69b1eea9127049d38c65290f13844de10bcc4807.png "docker2")
...
[![WSL5](https://cdn3.ldstatic.com/optimized/4X/c/3/8/c3894e436e548117ae357c1b18015ed5509561d9_2_517x290.png)

WSL5971×546 80.9 KB

](https://cdn3.ldstatic.com/original/4X/c/3/8/c3894e436e548117ae357c1b18015ed5509561d9.png "WSL5")

想不想要像下面这样美观呢

[![WSL6](https://cdn3.ldstatic.com/optimized/4X/3/2/b/32bb6d898dc5cf0af445655e97b4667a1f46c049_2_690x118.png)

WSL61795×307 39.6 KB

](https://cdn3.ldstatic.com/original/4X/3/2/b/32bb6d898dc5cf0af445655e97b4667a1f46c049.png "WSL6")

[![WSL7](https://cdn3.ldstatic.com/optimized/4X/4/1/4/414c8a66730fa33ddd80089e4f491686c84303d7_2_690x44.png)

WSL71792×116 12.2 KB

](https://cdn3.ldstatic.com/original/4X/4/1/4/414c8a66730fa33ddd80089e4f491686c84303d7.png "WSL7")

[![WSL8](https://cdn3.ldstatic.com/optimized/4X/5/4/e/54e868a2c367b6acc08a3b55e6986cfe4061b196_2_690x372.png)

WSL81788×965 221 KB

](https://cdn3.ldstatic.com/original/4X/5/4/e/54e868a2c367b6acc08a3b55e6986cfe4061b196.png "WSL8")
...
[![zsh](https://cdn3.ldstatic.com/optimized/4X/b/2/1/b2100b332b140191d420a6d46d49b81d15acddb0_2_480x374.png)

zsh915×714 77.8 KB

](https://cdn3.ldstatic.com/original/4X/b/2/1/b2100b332b140191d420a6d46d49b81d15acddb0.png "zsh")
...
[![nerdfonts](https://cdn3.ldstatic.com/optimized/4X/1/e/c/1ec5b2a682f30d17e9aad2c96086c7c947f65fc2_2_462x374.png)

nerdfonts1068×866 80 KB

](https://cdn3.ldstatic.com/original/4X/1/e/c/1ec5b2a682f30d17e9aad2c96086c7c947f65fc2.png "nerdfonts")

然后切换终端字体，以 Tabby 为例

[![tabby1](https://cdn3.ldstatic.com/optimized/4X/0/3/6/0361109ad00d8371e6e7c5086b5b609763c95dda_2_517x356.jpeg)

tabby11851×1275 267 KB

](https://cdn3.ldstatic.com/original/4X/0/3/6/0361109ad00d8371e6e7c5086b5b609763c95dda.jpeg "tabby1")

一般有三种可选，具体在字符宽度、间距等显示样式细节上有些区别，可以分别试试然后在下方的预览处选出自己最喜欢的

[![tabby2](https://cdn3.ldstatic.com/original/4X/5/a/e/5aec78daa1fb8cb99adef46314f4cbeb1b7a0b45.png)

tabby2339×222 14.5 KB

](https://cdn3.ldstatic.com/original/4X/5/a/e/5aec78daa1fb8cb99adef46314f4cbeb1b7a0b45.png "tabby2")
...
[![zshrc](https://cdn3.ldstatic.com/optimized/4X/7/9/8/798d565855204b5bb3e28344d2ea5ea3ef404db0_2_517x219.jpeg)

zshrc1017×432 62.5 KB

](https://cdn3.ldstatic.com/original/4X/7/9/8/798d565855204b5bb3e28344d2ea5ea3ef404db0.jpeg "zshrc")
